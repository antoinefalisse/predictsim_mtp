...
int F_generic(const T** arg, T** res) {
	...
	OpenSim::Body* pelvis;
	pelvis = new OpenSim::Body("pelvis", 8.84259808706309335946, Vec3(-0.06827780017111793887, 0.00000000000000000000, 0.00000000000000000000), Inertia(0.07718596275367972659, 0.06539783420083174204, 0.04347341676496163654, 0., 0., 0.));
	...
	OpenSim::Body* torso;
	torso = new OpenSim::Body("torso", 25.70607910907229154418, Vec3(-0.02676026676359908804, 0.30650513962530268053, 0.00000000000000000000), Inertia(1.10710799689008498881, 0.56725675934246133636, 1.07474695608577008876, 0., 0., 0.));
	model->addBody(torso);
