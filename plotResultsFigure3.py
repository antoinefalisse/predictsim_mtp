...
for i, ax in enumerate(axs[:, 0]):
        ...
        if not i == jointsToPlot.index("mtp_angle_r"):
            for case in cases_no_mtp:
                ax.plot(optimaltrajectories_no_mtp[case]['GC_percent'],
                        optimaltrajectories_no_mtp[case]['coordinate_values'][idxJointsToPlot_no_mtp[count]:idxJointsToPlot_no_mtp[count]+1, :].T, c=colors[1], linestyle=linestyles[1], linewidth=3, label='case_' + case + '_no_mtp')   
    ...
    for case in cases_mtp:
        ax.plot(optimaltrajectories[case]['GC_percent'],
                optimaltrajectories[case]['coordinate_values'][idxJointsToPlot[i]:idxJointsToPlot[i]+1, :].T, c=colors[0], linestyle=linestyles[0], linewidth=3, label='case_' + case + '_mtp')
...
musclesToPlot = ['glut_med2_r', 'glut_min1_r', 'semiten_r', 'bifemsh_r', 
                 'vas_med_r', 'vas_lat_r',
...
for i, ax in enumerate(axs[1:4,2:].flat):
    ...
    if i < NMusclesToPlot:
        ...
        for case in cases_no_mtp:
            ax.plot(optimaltrajectories_no_mtp[case]['GC_percent'],
                    optimaltrajectories_no_mtp[case]['muscle_activations'][idxMusclesToPlot[i]:idxMusclesToPlot[i]+1, :].T, c=colors[1], linestyle=linestyles[1], linewidth=3, label='case_' + case + '_no_mtp')            
        for case in cases_mtp:
            ax.plot(optimaltrajectories[case]['GC_percent'],
                    optimaltrajectories[case]['muscle_activations'][idxMusclesToPlot[i]:idxMusclesToPlot[i]+1, :].T, c=colors[0], linestyle=linestyles[0], linewidth=3, label='case_' + case + '_mtp')  
...
for i, ax in enumerate(axs[:,1]):
    ...
    if i < NJointsToPlot:
        ...
        if not i == jointsToPlot.index("mtp_angle_r"):
            for case in cases_no_mtp:
                ax.plot(optimaltrajectories_no_mtp[case]['GC_percent'],
                        optimaltrajectories_no_mtp[case]['joint_torques'][idxJointsToPlot_no_mtp[count]:idxJointsToPlot_no_mtp[count]+1, :].T, c=colors[1], linestyle=linestyles[1], linewidth=3, label='case_' + case + '_no_mtp')            
        ...
        for case in cases_mtp:
            ax.plot(optimaltrajectories[case]['GC_percent'],
                    optimaltrajectories[case]['joint_torques'][idxJointsToPlot[i]:idxJointsToPlot[i]+1, :].T, c=colors[0], linestyle=linestyles[0], linewidth=3, label='case_' + case + '_mtp')  
...
for i, ax in enumerate(axs[0,2:]):
    ...
    if i < NGRFToPlot:
        ...
        for case in cases_no_mtp:
            ax.plot(optimaltrajectories_no_mtp[case]['GC_percent'],
                    optimaltrajectories_no_mtp[case]['GRF'][idxGRFToPlot[i]:idxGRFToPlot[i]+1, :].T, c=colors[1], linestyle=linestyles[1], linewidth=3, label='case_' + case + '_no_mtp')  
        ...
        for case in cases_mtp:
            ax.plot(optimaltrajectories[case]['GC_percent'],
                    optimaltrajectories[case]['GRF'][idxGRFToPlot[i]:idxGRFToPlot[i]+1, :].T, c=colors[0], linestyle=linestyles[0], linewidth=3, label='case_' + case + '_mtp')  
