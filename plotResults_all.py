...
jointToPlot_no_mtp = ['pelvis_tilt', 'pelvis_list', 'pelvis_rotation', 
               'pelvis_tx', 'pelvis_ty', 'pelvis_tz', 
               'hip_flexion_r', 'hip_adduction_r', 'hip_rotation_r', 
               'knee_angle_r',  'ankle_angle_r', 
               'subtalar_angle_r',
...
idxJointsToPlot_no_mtp = getJointIndices(joints_no_mtp, jointToPlot_no_mtp)

NJointsToPlot = len(jointToPlot)  
NJointsToPlot_no_mtp = len(jointToPlot_no_mtp)   
