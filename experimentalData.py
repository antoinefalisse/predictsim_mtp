# -*- coding: utf-8 -*-
"""
Created on Tue Sep  8 15:57:26 2020
...
headers = {}
headers["GRF"] = {}
headers["GRF"]["right"] = ["1_ground_force_vx", "1_ground_force_vy", "1_ground_force_vz"]
headers["GRF"]["left"] = ["ground_force_vx", "ground_force_vy", "ground_force_vz"]
...
headers["GRF_adj"]["all"] = headers["GRF_adj"]["right"] + headers["GRF_adj"]["left"]
...
from variousFunctions import getInitialContact
...
for subject in trials:    
    ...
    for idxTrial, trial in enumerate(trials["subject1"]["names"]):
        ...
        # right leg than exist for the left leg.
